$(document).ready(function () {
    ...
    $(".filter").mouseleave(function () {
        $(".filter_price").hide(100)
    })
    $(".categories").click(function () {
        $(".category_dropdown").slideToggle(200)
    })
    ...
    $('#One_owl .owl-carousel').owlCarousel({
        loop: true,
        margin: 10,
        nav: false,
        dots: false,
    ...
    var owl = $('#One_owl .owl-carousel');
    owl.owlCarousel();
    $('#One_owl .right').click(function () {
        owl.trigger('next.owl.carousel', [400]);
    })
    $('#One_owl .left').click(function () {
